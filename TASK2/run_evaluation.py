...
if __name__ == "__main__":
    output = run_single_eval('Scalable Neural Network Verification with Branch-and-bound Inferred Cutting Planes', '''Recently, cutting-plane methods such as GCP-CROWN have been explored to
